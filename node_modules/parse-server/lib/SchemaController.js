...
exports.defaultColumns = exports.systemClasses = exports.buildMergedSchemaObject = exports.invalidClassNameMessage = exports.classNameIsValid = exports.load = undefined;
...
var _MongoSchemaCollection = require('./Adapters/Storage/Mongo/MongoSchemaCollection');
  ...
  _createClass(SchemaController, [{
    ...
    value: function validateField(className, fieldName, type, freeze) {
      ...
      return this.reloadData().then(function () {
        ...
        _this5._collection.transform.transformKey(_this5, className, fieldName);
      ...
      return this.reloadData().then(function () {
        ...
        if (_this6.data[className][fieldName].type == 'Relation') {
          ...
          return database.adapter.deleteFields(className, [fieldName], []).then(function () {
            return database.adapter.dropCollection('_Join:' + fieldName + ':' + className);
          });
        }
